...
class TextRecognizerPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (final textBlock in recognizedText.blocks) {
      ...
      bool isTapInsidePolygon = isInsideSquare(lastTapPosition!.dx, lastTapPosition!.dy, left, top, right, bottom);
      int index = selectedTexts.indexWhere((element) => element.text.contains(textBlock.text));
      ...
      // ..color = Colors.lightGreenAccent;
        ..color = index >= 0 ? Colors.white :colorsList[Random().nextInt(colorsList.length)];
